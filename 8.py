...
while fanari1!=0 or fanari2!=0 or fanari3!=0:
 if max(fanari1,fanari2,fanari3)==fanari1 :
    ...
    if fanari1>=autokinhtagone:
     ...
     print ('meta to anama fanari1:',0,'fanari2',fanari2,'fanari3',fanari3,'efugan apo to fanari1',fanari1,'autokinhta','sto fanari2 hrthan',autokinhtacome2,'autokinhta','kai sto fanari3 hrthan',autokinhtacome3,'autokinhta')
     fanari1=0
     ...
     if fanari2>=autokinhtagone:
      ...
      print ('meta to anama fanari1:',fanari1,'fanari2',0,'fanari3',fanari3,'efugan apo to fanari2',fanari2,'autokinhta','sto fanari1 hrthan',autokinhtacome2,'autokinhta','kai sto fanari3 hrthan',autokinhtacome3,'autokinhta')
      fanari2=0
     ...
     if fanari3>=autokinhtagone:
         ...
         print ('meta to anama fanari1:',fanari1,'fanari2',fanari2,'fanari3',0,'efugan apo to fanari3',fanari3,'autokinhta','sto fanari2 hrthan',autokinhtacome3,'autokinhta','kai sto fanari1 hrthan',autokinhtacome2,'autokinhta')
         fanari3=0
